"""
Helper script to launch an in-game Rocket League match with SenseiBot using RLBot.
"""
...
def main():
    print("=" * 60)
    print("      LAUNCHING SENSEIBOT IN-GAME (RLBOT)             ")
    print("=" * 60)
    ...
    print("Configuring 1v1 match: SenseiBot vs Human/Psyonix Bot...")
